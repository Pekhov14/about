...
const description = 'Hello, I\'m Anthony. 👋 I An software developer specializing in backend I usually use PHP (OpenCart, Symfony, Laravel) and a little frontend in JS (React, Next).';
