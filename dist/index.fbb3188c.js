...
})({"ceXIk":[function(require,module,exports) {
"use strict";
...
var _accordionUtilsJs = require("./accordionUtils.js");
...
const generatedElements = (0, _accordionUtilsJs.generateAccordionElements)((0, _faqData.faqData));
(0, _accordionUtilsJs.renderAccordionElements)(generatedElements, "faq");
(0, _accordionUtilsJs.toggleAccordion)();

},{"@studio-freight/lenis":"ggVJc","gsap":"fPSuC","./preloader":"fr1Gn","./faqData":"e1MQz","gsap/ScrollTrigger":"7wnFk","./accordionUtils.js":"4cKVB","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ggVJc":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
var o = /*#__PURE__*/ function(t2) {
    var o1, i1;
    function n1(r1) {
        var o2, i, n, l, s = void 0 === r1 ? {} : r1, c = s.lerp, p = void 0 === c ? .1 : c, a = s.smooth, h = void 0 === a || a, d = s.direction, f = void 0 === d ? "vertical" : d, v = s.wrapper, u = void 0 === v ? window : v, w = s.content, g = void 0 === w ? document.body : w;
        (l = t2.call(this) || this).onWindowResize = function() {
            l.wrapperWidth = window.innerWidth, l.wrapperHeight = window.innerHeight;
        }, l.onWrapperResize = function(t) {
            var e = t[0];
            if (e) {
                var r2 = e.contentRect;
                l.wrapperWidth = r2.width, l.wrapperHeight = r2.height;
            }
        }, l.onContentResize = function(t) {
            var e = t[0];
            if (e) {
                var r3 = e.contentRect;
                l.contentWidth = r3.width, l.contentHeight = r3.height;
            }
        }, l.onVirtualScroll = function(t) {
            var e = t.deltaY, r4 = t.originalEvent;
            r4.ctrlKey || (l.stopped ? r4.preventDefault() : (l.smooth && r4.preventDefault(), l.targetScroll -= e, l.targetScroll = Math.max(0, Math.min(l.targetScroll, l.limit))));
        ...
        var y = (null == (o2 = navigator) || null == (i = o2.userAgentData) ? void 0 : i.platform) || (null == (n = navigator) ? void 0 : n.platform) || "unknown";
    ...
    i1 = t2, (o1 = n1).prototype = Object.create(i1.prototype), o1.prototype.constructor = o1, r(o1, i1);
    var l1, s1, c1 = n1.prototype;
    return c1.start = function() {
        this.stopped = !1;
    }, c1.stop = function() {
        this.stopped = !0;
    }, c1.destroy = function() {
    ...
    }, c1.scrollTo = function(t, e) {
        var r5, o3 = void 0 === e ? {} : e, i = o3.offset, n = void 0 === i ? 0 : i, l = o3.immediate, s = void 0 !== l && l;
        if ("number" == typeof t) r5 = t;
        else if ("top" === t) r5 = 0;
        else if ("bottom" === t) r5 = this.limit;
        else {
            var c;
            ...
            r5 = ("horizontal" === this.direction ? h.left : h.top) + this.scroll - p;
        }
        this.targetScroll = r5 += n, this.scrolling = !0, this.smooth && !s || (this.scroll = r5, this._scrollTo(this.scroll));
    }, l1 = n1, s1 = [
        {
            key: "scrollProperty",
            get: function() {
        ...
        for(var r6 = 0; r6 < e.length; r6++){
            var o4 = e[r6];
            o4.enumerable = o4.enumerable || !1, o4.configurable = !0, "value" in o4 && (o4.writable = !0), Object.defineProperty(t, o4.key, o4);
        }
    }(l1.prototype, s1), Object.defineProperty(l1, "prototype", {
        writable: !1
    }), n1;
...
},{"./gsap-core.js":"05eeC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fr1Gn":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{}],"e1MQz":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "faqData", ()=>faqData);
const faqData = {
    1: {
    ...
    2: {
        question: "Do you have pet projects?",
        answer: "Oh sure! I developed a PHP Telegram bot to send good morning messages to my friends and random compliments for the day. I made a bot for Tinder using Python + Selenium. I also created a console application for my brother for special formatting of Telegraph posts (Symfony CLI). Additionally, I made an admin panel for my site using EasyAdmin 4. I've also worked on various small projects for training and routine tasks."
    },
    3: {
    ...
    7: {
        ...
        answer: "I can communicate by correspondence, but my current level of conversation does not allow me to freely express my thoughts. \uD83D\uDC82"
    },
    8: {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4cKVB":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "generateAccordionElements", ()=>generateAccordionElements);
parcelHelpers.export(exports, "renderAccordionElements", ()=>renderAccordionElements);
parcelHelpers.export(exports, "toggleAccordion", ()=>toggleAccordion);
function generateAccordionElements(data) {
    let result = "";
...
function renderAccordionElements(data, dataPlacementId) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["ceXIk","bDbGG"], "bDbGG", "parcelRequire601c")
